...
/**
 * Expose `var urlomatic = require('url-o-matic')`
 * Call `urlomatic.baseurl('http://www.location.com/')`
 */
...
/**
 * Parse and return the root URL from any valid URL or IP address.
 *
 *
 * @param (string) URL or IP
...
{
  urlomatic = {
	  /* lifted from Ben Lowry, https://github.com/playtomic/apiserver/blob/master/api/utils.js */
